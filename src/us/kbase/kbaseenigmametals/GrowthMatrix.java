...
public class GrowthMatrix {
    ...
    public GrowthMatrix withRowMetadata(GenericSeriesMetadata rowMetadata) {
        this.rowMetadata = rowMetadata;
        return this;
    }
    ...
    public GrowthMatrix withColumnMetadata(TimeSeriesMetadata columnMetadata) {
        this.columnMetadata = columnMetadata;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((("GrowthMatrix"+" [name=")+ name)+", description=")+ description)+", rowMetadata=")+ rowMetadata)+", columnMetadata=")+ columnMetadata)+", data=")+ data)+", additionalProperties=")+ additionalProperties)+"]");
    }
